...
const StatusBadge = memo(() => (
  <div
    className="inline-block animate-float lg:mx-0 mt-32 sm:mt-96 md:mt-20"
    data-aos="zoom-in"
    data-aos-delay="400"
  >
...
const WORDS = ["Passionate Developer", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/raasikkk" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/rasul-zhankeldyuly/" },
  { icon: Instagram, link: "https://www.instagram.com/raasikkk" },
];
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 xl:ml-20"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Crafting innovative, functional, and user-friendly digital
